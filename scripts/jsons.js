...
export let quotes = [
    ...
    "Nunca se es demasiado viejo para fijar otra meta o para soñar un ",
    " ",
    "Lo que no te mata, te hace más fuerte",
    "El hombre que mueve montañas comienza cargando pequeñas piedras ",
    "Buenos amigos, buenos libros y una conciencia tranquila: esa es la vida ideal - Mark Twain",
    ...
    "Unas palabras amables, un libro cálido y una sonrisa honesta pueden hacer milagros - William Hazlitt",
    ...
    "La alegría reside en la alegría del logro y en la emoción del esfuerzo creativo - Franklin Roosevelt",
    ...
    "Da el ",
    " con fe. No tienes que ver todas las escaleras, sólo da el  ",
    " ",
    ...
    "Casi todas las ",
    " que suceden en el mundo, nacen de una actitud de aprecio por los demás ",
    ...
    "La sencillez es una forma de humildad y la sencillez es una señal de la verdadera grandeza - Vince Lombardi",
    ...
    "La mejor forma de olvidar las malas cosas de la vida es aprender a recordar las ",
    " ",
